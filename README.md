...
#### <u>**事先声明：本人纯小白，大量代码来源于AI（aistudio.google），请喷轻点。**</u>  
...
### **请在项目根目录下创建文件夹结构： public/ -> libs/，然后下载以下文件：**
...
*   **保存为**: public/libs/tailwindcss.js  
    _(注意：打开链接后全是代码，请右键“另存为”或复制全部内容新建文件)_
    

### **2\. KaTeX CSS (Math Formatting)**
...
### **3\. Mammoth.js (Browser Version)**

用于将 .docx Word 文档转换为 HTML。

*   **下载地址**: https://cdn.jsdelivr.net/npm/mammoth@1.6.0/mammoth.browser.min.js
    
*   **保存为**: public/libs/mammoth.browser.min.js
    

### **4\. PDF.js (Main Library & Worker)**

用于读取和渲染 PDF 文件（AI 导入功能依赖此库）。你需要下载两个文件。

*   **主文件下载**: https://cdn.jsdelivr.net/npm/pdfjs-dist@3.11.174/build/pdf.min.js
    
    *   **保存为**: public/libs/pdf.js (注意重命名去掉 .min)
    
*   **Worker文件下载**: https://cdn.jsdelivr.net/npm/pdfjs-dist@3.11.174/build/pdf.worker.min.js
    
    *   **保存为**: public/libs/pdf.worker.js (注意重命名去掉 .min)
